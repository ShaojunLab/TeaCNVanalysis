...
setwd(work_dir)
outdir <- work_dir
#outdir <- '~/Library/Mobile Documents/com~apple~CloudDocs/code/code_CNV/TeaCNVAnalysis'
cytoBandFile <- file.path("~/Library/Mobile Documents/com~apple~CloudDocs/code/code_CNV/github/TeaCNV/data/cytoBand_hg38.tsv")
normal_cnv_file <- file.path(work_dir,"Rdata/2021415KP_WGS_bincounts.csv")
...
for(sample in samples_tumor){
    cnv_file <- file.path(work_dir,"Rdata",paste0(sample,"_WGS_bincounts.csv"))
